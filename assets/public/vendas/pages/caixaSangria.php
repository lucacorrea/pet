<?php
// autoErp/public/caixa/pages/caixaSangria.php
...
// CSRF exclusivo
if (empty($_SESSION['csrf_sangria'])) {
  $_SESSION['csrf_sangria'] = bin2hex(random_bytes(32));
}
$csrf = $_SESSION['csrf_sangria'];
  ...
  <div class="position-relative iq-banner">
    ...
    <div class="iq-navbar-header" style="height:140px; margin-bottom:30px;">
      <div class="container-fluid iq-container">
        <div class="row">
          <div class="col-12">
            <h1 class="mb-0">Sangria do Caixa</h1>
            <p>Registre a retirada de dinheiro do caixa aberto (depósito/segurança).</p>
            <?php if (!$caixa): ?>
  ...
  <div class="container-fluid content-inner mt-n3 py-0">
    <div class="row justify-content-center">
      <div class="col-12 col-lg-7">
        <form method="post" action="../actions/caixaSangriaSalvar.php" class="card" autocomplete="off">
          <div class="card-header d-flex justify-content-between align-items-center">
            <h5 class="mb-0"><i class="bi bi-arrow-down-circle me-1"></i> Nova Sangria</h5>
            <div class="d-flex gap-2">
              <a href="./caixaSuprimento.php" class="btn btn-outline-dark btn-sm"><i class="bi bi-arrow-up-circle"></i> Suprimento</a>
          ...
          <div class="card-body">
            ...
            <div class="mb-3">
              ...
              <div class="form-text">Retirada de dinheiro do caixa (ex.: depósito em cofre/banco).</div>
            </div>

            <div class="mb-3">
              <label class="form-label">Observação</label>
              <textarea name="observacao" class="form-control" rows="3" placeholder="Ex.: sangria para depósito" <?= $caixa?'':'disabled' ?>></textarea>
            </div>

            <div class="d-grid">
              <button type="submit" class="btn btn-danger" <?= $caixa?'':'disabled' ?>>
                <i class="bi bi-check2-circle me-1"></i> Confirmar Sangria
              </button>
            </div>
          </div>
        </form>
