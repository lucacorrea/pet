...
.nfce-input .inp{
  ...
  border:2px dashed #c7d2fe; border-radius:12px; font-weight:700;
}
...
.kbd{background:#0f172a;color:#fff;border:1px solid #0f172a;border-radius:.35rem;padding:.12rem .38rem}
  ...
  <div class="right">
    <div class="totalzao">
      <div class="d-flex justify-content-between">
        <span>Itens</span><strong id="tot-itens">0</strong>
      </div>
