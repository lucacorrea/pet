      ...
      <div class="sidebar-list">
        <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
          ...
          <li class="nav-item active">
            <a class="nav-link" data-bs-toggle="collapse" href="#sidebar-estoque" role="button" aria-expanded="false" aria-controls="sidebar-estoque">
              <i class="bi bi-truck icon"></i><span class="item-name">Estoque</span><i class="bi bi-chevron-right right-icon"></i>
            </a>
            <ul class="sub-nav collapse" id="sidebar-estoque" data-bs-parent="#sidebar-menu">
              <li class="nav-item">
          ...
          <li class="nav-item">
            ...
            <ul class="sub-nav collapse" id="sidebar-relatorios" data-bs-parent="#sidebar-menu">
              ...
              <li class="nav-item">
                <a class="nav-link" href="../../lavajato/pages/relatorioLavagens.php">
                  <i class="bi bi-pie-chart icon"></i><span class="item-name">Relatórios de Lavagens</span>
                </a>
