...
$id = (int)($_GET['id'] ?? 0);
if ($id <= 0) {
  header('Location: ./produtos.php?err=1&msg=Produto inválido');
  exit;
}
...
if (!$produto) {
  header('Location: ./produtos.php?err=1&msg=Produto não encontrado');
  exit;
}
...
{
  return htmlspecialchars((string)($arr[$k] ?? $def), ENT_QUOTES, 'UTF-8');
}
function n($arr, $k)
{
  return number_format((float)($arr[$k] ?? 0), 2, ',', '.');
}
function n3($arr, $k)
{
  return number_format((float)($arr[$k] ?? 0), 3, ',', '.');
}
?>
<!doctype html>
      ...
      <div class="row">
        <div class="col-12">
          <div class="card" data-aos="fade-up" data-aos-delay="150">
            ...
            <div class="card-body">
              <form method="post" action="../actions/produtoEditar.php" autocomplete="off">
