<?php
// autoErp/public/lavajato/pages/servicosNovo.php
declare(strict_types=1);

if (session_status() === PHP_SESSION_NONE) session_start();

require_once __DIR__ . '/../../../lib/auth_guard.php';
guard_empresa_user(['dono', 'administrativo']); // só dono e administrativo podem cadastrar serviços
...
// CSRF para este form
if (empty($_SESSION['csrf_servico_novo'])) {
  $_SESSION['csrf_servico_novo'] = bin2hex(random_bytes(32));
}
$csrf = $_SESSION['csrf_servico_novo'];
...
<head>
  ...
  <title>AutoERP — Novo Serviço</title>
...
<body>
  ...
  <body>
    <?php
    if (session_status() === PHP_SESSION_NONE) session_start();
    $menuAtivo = 'lavajato-add-servico'; // sem espaço
      ...
      <div class="position-relative iq-banner">
        ...
        <div class="iq-navbar-header" style="height: 150px; margin-bottom: 50px ;">
          <div class="container-fluid iq-container">
            <div class="row">
              <div class="col-md-12">
                <h1 class="mb-0">Cadastrar Serviço</h1>
                <p>Informe os dados do serviço do Lava Jato.</p>

                <?php if ($ok || $err): ?>
                  <div class="mt-3">
                    <?php if ($ok): ?><div class="alert alert-success py-2 mb-0"><?= htmlspecialchars($msg ?: 'Serviço cadastrado com sucesso.', ENT_QUOTES, 'UTF-8') ?></div><?php endif; ?>
                    <?php if ($err): ?><div class="alert alert-danger py-2 mb-0"><?= htmlspecialchars($msg ?: 'Falha ao cadastrar serviço.', ENT_QUOTES, 'UTF-8') ?></div><?php endif; ?>
                  </div>
                <?php endif; ?>
              </div>
            </div>
          ...
          <div class="col-12">
            <div class="card" data-aos="fade-up" data-aos-delay="150">
              <div class="card-header">
                <h4 class="card-title mb-0">Dados do Serviço</h4>
              </div>
              <div class="card-body">
                <form method="post" action="../actions/servicosSalvar.php" id="form-servico">
                  <input type="hidden" name="op" value="servico_novo">
