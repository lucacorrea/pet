        ...
        <div class="text-center text-muted py-5">
          ...
          <div class="mt-2">Ainda não há vendas para o período selecionado.</div>
            ...
            const options = {
                ...
                // *** Forçamos cores para garantir a linha visível ***
                colors: ['#3b82f6'], // azul (Tailwind blue-500)
                stroke: {
                    curve: 'smooth',
                    width: 3,
                    colors: ['#2563eb'] // azul mais escuro (blue-600) -> linha
                },
                markers: {
                    size: 4,
                    strokeWidth: 2,
                    strokeColors: isDark ? '#0f172a' : '#ffffff' // contraste com o fundo
                },
                dataLabels: {
                    enabled: false
                },
                ...
                fill: {
                    ...
                    gradient: {
                        shadeIntensity: 1,
                        opacityFrom: 0.35, // mais opaco para ficar visível
                        opacityTo: 0.05,
                        stops: [0, 90, 100]
                    }
                },
